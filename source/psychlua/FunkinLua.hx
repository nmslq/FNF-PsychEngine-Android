...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set("getColorFromRGB", function(color:String) {
		...
		set("setColorSwap", function(obj:String, hue:Float = 0, saturation:Float = 0, brightness:Float = 0) {
		...
		set("getTouchX", function(camera:String) {
			#if android
			var cam:FlxCamera = LuaUtils.cameraFromString(camera);
			for (touch in FlxG.touches.list) {
		...
		set("getTouchY", function(camera:String) {
			#if android
			var cam:FlxCamera = LuaUtils.cameraFromString(camera);
			for (touch in FlxG.touches.list)
		...
		set("setObjectOrigin", function(obj:String, originX:Float, originY:Float) {
