...
class Controls
{
	...
	function checkAndroidKeys(key:String, press:String):Bool
	{
		...
		var buttons = [virtualPad.buttonA, virtualPad.buttonB, virtualPad.buttonUp, virtualPad.buttonDown, virtualPad.buttonLeft, virtualPad.buttonRight, androidControls.hitbox.hints[0], androidControls.hitbox.hints[1], androidControls.hitbox.hints[2], androidControls.hitbox.hints[3]];

		if (controlsType == 1)
		{
			buttons[6] = androidControls.virtualPad.buttonLeft;
			buttons[7] = androidControls.virtualPad.buttonDown;
			buttons[8] = androidControls.virtualPad.buttonUp;
			buttons[9] = androidControls.virtualPad.buttonRight;
		}
