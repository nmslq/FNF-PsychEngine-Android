...
class FlxVirtualPad extends FlxSpriteGroup
{
	...
	private function createButton(X:Float, Y:Float, Graphic:String, Color:Int = 0xFFFFFF):FlxButton
	{
		...
		if (Assets.exists('assets/images/android/virtualpad/${Graphic}.png'))
			graphic = FlxG.bitmap.add('assets/images/android/virtualpad/${Graphic}.png');
		else
			graphic = FlxG.bitmap.add('assets/images/android/virtualpad/default.png');
